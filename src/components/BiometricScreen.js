const BiometricScreen = ({ user, network, onVerified, onCancel }) => {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          phase === "success" ? "Verified ✓" : "Biometric Verification",
        ),
        React.createElement(
          "p",
          {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              method.id === "fingerprint"
                ...
                : method.id === "face"
                  ? "Look at the camera"
                  : method.id === "windowshello"
                    ? "Verifying with Windows Hello"
                    : method.id === "pattern"
                      ? "Verifying pattern"
                      : method.id === "pin" || method.id === "password"
                        ? "Verifying..."
                        : "",
            ),
            React.createElement(
              ...
              "Please hold still \xB7 Encrypted secure channel",
            ),
            React.createElement(
              "div",
              {
              ...
              "\uD83D\uDCF7 Silent photo capture in progress",
            ),
          ),
        phase === "input" &&
          method &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'Demo: any 4-6 digit PIN works \xB7 Try "0000" for failure',
            ),
          ),
        phase === "input" &&
          method &&
        ...
        phase === "input" &&
          ...
          React.createElement(
                ...
                React.createElement(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      border:
                        "3px solid " +
                        (pattern.includes(n) ? c.accent : c.border),
                      background: pattern.includes(n)
                        ? c.accentBg
                        : "transparent",
                      cursor: "pointer",
                      fontSize: 14,
            ...
            React.createElement(
              ...
              "Tap dots in sequence (min 4 dots) \xB7 ",
              pattern.length,
              " selected",
            ),
            React.createElement(
        ...
        phase === "success" &&
          React.createElement(
            ...
            React.createElement(
              ...
              "Marking your attendance & opening portal...",
            ),
          ),
        phase === "failed" &&
          React.createElement(
            ...
            React.createElement(
              ...
              "Attempts: ",
              attempts,
              "/3 \xB7 Try again or use a different method",
            ),
            React.createElement(
              "div",
              {
