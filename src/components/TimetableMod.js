const TimetableMod = ({
  ...
  return React.createElement("div", null, React.createElement("div", {
    ...
    options: filteredTeachers.map(t => {
      ...
      return { value: realIdx, label: "#" + t.sno + " " + t.name + " (" + t.code + ") - " + t.location };
    }),
  ...
  }, "Teacher"), React.createElement(SearchableSelect, {
    value: qbTeacher,
    onChange: val => setQbTeacher(parseInt(val)),
    options: teachers.map((t, i) => ({ value: i, label: "#" + t.sno + " " + t.name + " (" + t.code + ") - " + (t.location || "IBA") })),
    placeholder: "Select teacher...",
    style: {
      width: "100%"
    }
