const DashMod = ({ teachers, setPage, students }) => {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          " \xB7 Here's what's happening at LLQA today",
        ),
      ),
      React.createElement(
        "div",
      ...
      [
        {
          ...
          value: at.length,
          sub:
            at.filter((t) => t.gender === "Male").length +
            "M · " +
            at.filter((t) => t.gender === "Female").length +
            "F",
          icon: Users,
          col: c.accent,
          page: "teachers",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        [
          [
            "Male IBA",
            at.filter((t) => t.gender === "Male" && t.location === "IBA")
              .length,
            c.accent,
          ],
          [
            "Male WFH",
            at.filter((t) => t.gender === "Male" && t.location === "WFH")
              .length,
            c.cyan,
          ],
          [
            "Female IBA",
            at.filter((t) => t.gender === "Female" && t.location === "IBA")
              .length,
            c.purple,
          ],
          [
            "Female WFH",
            at.filter((t) => t.gender === "Female" && t.location === "WFH")
              .length,
            c.success,
          ],
        ].map(([l, v, col]) =>
