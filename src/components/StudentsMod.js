const StudentsMod = ({
  ...
  const canAdd =
    ...
    user.role === "teamlead" ||
    (user.role &&
      user.role.indexOf("custom:") === 0 &&
      user.customPermissions &&
      user.customPermissions["Manage Students"]);
  ...
  const fd = useMemo(() => {
    ...
    if (search)
      d = d.filter((s) =>
        [s.name, s.parent, s.teacher, s.state, s.course, s.family].some((v) =>
  ...
  const saveP = () => {
    ...
    const dt =
      ...
      _spNow.getFullYear() +
        "-" +
        String(_spNow.getMonth() + 1).padStart(2, "0") +
        "-" +
        String(_spNow.getDate()).padStart(2, "0");
    setSts(
      sts.map((s) =>
        s.id === sid
          ? {
              ...
              attendance: Math.round(
                ((isP ? s.attended + 1 : s.attended) / (s.totalClasses + 1)) *
                  100,
              ),
              lB: pf.beh,
              lP: pf.perf,
    ...
    if (typeof setDailyProgress === "function") {
      setDailyProgress((prev) => {
        ...
        const entry = {
          id:
            idx >= 0 ? list[idx].id : "dp_" + dt + "_" + sid + "_" + Date.now(),
          studentId: sid,
          date: dt,
  ...
  const mAtt = (id, st) => {
    ...
    if (typeof setDailyProgress !== "function") {
      console.error(
        "%c[mAtt] FATAL: setDailyProgress is not a function!",
        "color:red;font-weight:bold",
        "typeof=",
        typeof setDailyProgress,
        "value=",
        setDailyProgress,
      );
      return;
    ...
    console.log(
      "[mAtt] setDailyProgress is callable, current dailyProgress count:",
    ...
    try {
      setDailyProgress((prev) => {
        ...
        const idx = list.findIndex(
          (p) => p.studentId === id && p.date === today,
        );
        const entry = {
          id:
            idx >= 0
              ? list[idx].id
              : "dp_" + today + "_" + id + "_" + Date.now(),
          studentId: id,
          date: today,
      ...
      console.log(
        "%c[mAtt] setDailyProgress invoked successfully",
        "color:#0f0",
      );
    } catch (e) {
  ...
  const pp = (s) =>
    s.course.includes("Quaida")
      ? Math.round((s.qaida / 30) * 100)
      : Math.round((s.page / 604) * 100);
  const bc = (b) =>
    b === "Excellent"
      ? c.success
      : b === "Good"
        ...
        : b === "Needs Improvement"
          ? c.warn
          : b === "Restless/Distracted" || b === "Disruptive"
            ? c.danger
            : c.textSec;
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(SC, {
        ...
        value:
          Math.round(
            act.reduce((a, s) => a + s.attendance, 0) / (act.length || 1),
          ) + "%",
        color: c.purple,
      }),
    ),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(Badge, {
                      text:
                        (s.course || "—").length > 14
                          ? (s.course || "—").substring(0, 12) + ".."
                          : s.course || "—",
                      color: (s.course || "").includes("Quaida")
                        ? "purple"
                        : (s.course || "").includes("Memo")
                          ? "cyan"
                          : "accent",
                    }),
                  ),
              ...
              React.createElement(
                "div",
                {
                  ...
                  style: {
                    ...
                    border:
                      "1px solid " +
                      (s.lastDate === todayPK() ? c.success + "66" : c.border),
                  },
                },
                React.createElement(
                  "div",
                        ...
                        React.createElement(
                          "span",
                          {
                            style: {
                              ...
                              borderRadius: 3,
                              background:
                                s.lH === "Completed" ? c.successBg : c.dangerBg,
                              color:
                                s.lH === "Completed" ? c.success : c.danger,
                            },
                          },
                          "HW: ",
                          s.lH,
            ...
            React.createElement(
              ...
              React.createElement(
                BarChart,
                {
                  data: [
                    ...
                    },
                    {
                      r: "85-89%",
                      n: act.filter(
                        (s) => s.attendance >= 85 && s.attendance < 90,
                      ).length,
                    },
                    {
                      r: "80-84%",
                      n: act.filter(
                        (s) => s.attendance >= 80 && s.attendance < 85,
                      ).length,
                    },
                    {
                      r: "<80%",
                ...
                React.createElement(
                  ...
                  [c.success, c.accent, c.warn, c.warn, c.danger].map(
                    (col, i) =>
                    ...
                    React.createElement(
                      "td",
                      {
                        style: {
                          padding: "7px 8px",
                          color:
                            s.totalClasses - s.attended > 20
                              ? c.danger
                              : c.warn,
                        },
                      },
                      s.totalClasses - s.attended,
                    ),
                    React.createElement(
                      "td",
                      {
    ...
    tab === "monthlySheet" &&
      React.createElement(MonthlyAttendanceGrid, {
        students: sts,
        setStudents: setSts,
      }),
    tab === "leaves" &&
              ...
              onLv.map((s) =>
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    "Reason: ",
                    s.lvReason || s.notes || "Not specified",
                  ),
                  s.fu1 &&
                    React.createElement(
                      "div",
    ...
    modal &&
      modal.type === "view" &&
      React.createElement(StudentDetailC, {
        s: modal.data,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              modal.data.course.includes("Quaida")
                ? "Qaida P." + modal.data.qaida + "/30"
                : "Juz " + modal.data.juz + " · Pg " + modal.data.page + "/604",
            ),
          ),
          React.createElement(
            "div",
          ...
          React.createElement(Inp, {
            ...
            placeholder: modal.data.course.includes("Quaida")
              ? "e.g. Qaida Page 19 - Joined Letters"
              : "e.g. Surah Al-Baqarah ayah 255-260",
          }),
          React.createElement(Inp, {
            label: modal.data.course.includes("Quaida")
              ? "Qaida Page"
              : "Quran Page",
            value: pf.page || "",
            onChange: (v) =>
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Student will be moved to Quit. Can be re-enrolled later.",
          ),
          React.createElement(Inp, {
            label: "Quit Date",
            value: pf.qDate || "",
