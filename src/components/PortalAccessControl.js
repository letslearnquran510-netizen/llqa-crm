const PortalAccessControl = ({ access, setAccess }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        "Portal Access Control (Super Admin Only)",
      ),
    ),
    React.createElement(
      "p",
      ...
      "Choose which tabs are visible to Team Leads and Teachers when they log in. Settings tab is always Super Admin only. Enabling a parent module (e.g. Operations) automatically grants all its sub-tabs; enabling only a sub-tab shows just that tab on its own.",
    ),
    React.createElement(
      "div",
      {
      ...
      React.createElement(
        ...
        React.createElement(
          "tbody",
          null,
          NAV.filter((n) => n.id !== "settings").map((n, i) =>
            React.createElement(
              "tr",
              {
                key: n.id,
