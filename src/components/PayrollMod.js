const PayrollMod = ({
  ...
  const currentRecs = useMemo(() => {
    return teachers.map((t) => {
      ...
      const tViols = (qcViolations || []).filter(
        (v) =>
          v.teacher === t.name &&
          v.date &&
      ...
      const autoFine = tViols.reduce(
        (sum, v) => sum + (Number(v.fine) || 0),
        0,
      );

      if (!rec) {
        const b =
          typeof calcBonuses === "function" ? calcBonuses(t) : { total: 0 };
        rec = {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      approved,
      paidAmount: recs
        .filter((t) => t.pay.status === "paid")
        .reduce((s, t) => s + t.pay.net, 0),
      pendingAmount: recs
        .filter(
          (t) => t.pay.status === "pending" || t.pay.status === "approved",
        )
        .reduce((s, t) => s + t.pay.net, 0),
    };
  }, [currentRecs]);
  ...
  const ytd = useMemo(() => {
    ...
    teachers.forEach((t) => {
      ...
      const totalEarned = recs
        .filter((r) => r.status === "paid")
        .reduce((s, r) => s + r.net, 0);
      const totalFines = recs
        .filter((r) => r.status === "paid")
        .reduce((s, r) => s + r.fine, 0);
      const totalBonuses = recs
        .filter((r) => r.status === "paid")
  ...
  const bulkApprove = () => {
    selected.forEach((id) =>
      updateRec(id, (r) =>
        r.status === "pending"
          ? { ...r, status: "approved", approvedBy: "Super Admin" }
          : r,
      ),
    );
    setSelected([]);
        ...
        React.createElement(
          Btn,
          {
            ...
            onClick: () => {
              ...
              alert(
                "Bank disbursement file downloaded. Upload to your bank portal.",
              );
            },
          },
          "Bank File",
              ...
              if (
                confirm(
                  "Process payroll for " +
                    ...
                    "\n\nThis will mark all salaries as paid for " +
                    (selectedMonth || "the current month") +
                    ".",
                )
              )
                alert(
              ...
              filtered.map((t, i) =>
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    "Rs ",
                    t.pay.baseSalary.toLocaleString(),
                  ),
                  React.createElement(
                    "td",
                    {
                  ...
                  React.createElement(
                    ...
                    "-Rs ",
                    t.pay.deductions.toLocaleString(),
                  ),
                  React.createElement(
                    "td",
                    {
    ...
    tab === "history" &&
      React.createElement(
        ...
        React.createElement(
          ...
          "Complete payment history across all months",
        ),
        React.createElement(
          "div",
          {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            [
              ["Tenure 3+ years", "Rs 3,000", c.success],
              ["Tenure 2 years", "Rs 2,000", c.success],
              ["Tenure 1 year", "Rs 1,000", c.success],
              ["Rating 4.5+", "Rs 3,000", c.purple],
              ["Rating 4.2-4.4", "Rs 2,000", c.purple],
              ["Rating 4.0-4.1", "Rs 1,000", c.purple],
              ["12+ Students", "Rs 2,000", c.accent],
              ["8+ Students", "Rs 1,000", c.accent],
            ].map(([l, v, col]) =>
              React.createElement(
                "div",
                {
              ...
              teachers.map((t, i) => {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    b.performance > 0 ? "Rs " + b.performance : "—",
                  ),
                  React.createElement(
                    "td",
                    {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Track salary advances and loan installments. Auto-deducted from monthly payroll.",
          ),
        ),
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              teachers
                .filter(
                  (t) =>
                    payHistory[t.id]?.find((r) => r.month === selectedMonth)
                      ?.advance > 0,
                )
                .map((t, i) => {
                  const rec = payHistory[t.id].find(
    ...
    tab === "ytd" &&
      React.createElement(
        ...
        React.createElement(
          ...
          "Year-to-date earnings, bonuses, taxes, and fines per teacher",
        ),
        React.createElement(
          "div",
          {
              ...
              teachers.map((t, i) => {
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    "Rs ",
                    y.months > 0
                      ? Math.round(y.totalEarned / y.months).toLocaleString()
                      : "0",
                  ),
                );
              }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            modal.data.name,
            " \xB7 Salary Rs ",
            modal.data.salary.toLocaleString(),
          ),
          ...
          React.createElement(
            ...
            "This will auto-deduct from next ",
            payForm.installments || 1,
            " month(s) payroll.",
          ),
          React.createElement(
            "div",
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              {
                style: {
                  color:
                    Number(payForm.newSalary) > modal.data.salary
                      ? c.success
                      : c.danger,
                  fontWeight: 700,
                },
              ...
              Number(payForm.newSalary) > modal.data.salary ? "+" : "",
              "Rs ",
              (Number(payForm.newSalary) - modal.data.salary).toLocaleString(),
            ),
            " (",
            Math.round(
              ((Number(payForm.newSalary) - modal.data.salary) /
