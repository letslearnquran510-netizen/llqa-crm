const SubjectsMod = ({
  ...
  const setTeachers = (newTeachers) => {
    ...
    setAppTeachers(
      appTeachers.map((at) => {
        ...
        const newTt = at._ttSchedule
          ? JSON.parse(JSON.stringify(at._ttSchedule))
          : {};
        const daysMap = {
          mon: "Mon",
          tue: "Tue",
        ...
        for (const lowerDay in daysMap) {
          ...
          SUBJ_SLOTS.forEach((slot) => {
            if (
              newTt[capDay][slot] &&
              typeof newTt[capDay][slot] === "object"
            ) {
              newTt[capDay][slot] = "F";
            }
          });
  ...
  const removeCell = () => {
    const { teacher, day, slotIdx } = cellModal;
    setTeachers(
      teachers.map((t) =>
        t.id === teacher.id
          ? {
              ...
              [day]: Object.fromEntries(
                Object.entries(t[day]).filter(([k]) => k !== String(slotIdx)),
              ),
            }
          : t,
      ),
  ...
  return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Click any free cell to paste here. You can also drag from a booked cell to copy.",
            ),
          ),
        ),
        React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        teachers.length,
        " subject teachers \xB7 ",
        stats.booked,
        " booked classes \xB7 ",
        stats.free,
        " free slots \xB7 ",
        subjShift === "weekend" ? "Sat-Sun schedule" : "Mon-Fri schedule",
      ),
      React.createElement(
        Btn,
        {
      ...
      [
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            k === "weekday" ? "08:00-07:30" : "09:00-16:30",
          ),
        ),
      ),
    ),
                    ...
                    onClick: () => {
                      if (t.phone)
                        window.location.href =
                          "tel:" + t.phone.replace(/[^0-9+]/g, "");
                      else
                        alert("Phone number not available for this teacher.");
                    },
                    style: {
                      background: c.bgDeep,
                      border: "1px solid " + c.border,
                      ...
                      React.createElement(
                        "th",
                        {
                          ...
                          style: {
                            ...
                            borderBottom:
                              "2px solid " + (i >= 24 ? c.purple : c.cyan),
                            color: c.text,
                            fontSize: 11,
                            fontWeight: 700,
                            letterSpacing: 0.2,
                        ...
                        return React.createElement(
                          "td",
                          {
                            ...
                            style: {
                              ...
                              border:
                                "1px solid " +
                                (hasClipboard && !isBooked ? c.warn : c.border),
                              background: isBooked
                                ? rColor(cell.sub) + "15"
                                : hasClipboard && !isBooked
                                  ? c.warnBg
                  ...
                  SUBJ_SLOTS.map((_, i) => {
                    ...
                    return React.createElement(
                      "td",
                      {
                        ...
                        onClick: () =>
                          isBooked
                            ? openCell(t, selDay, slotIdx, cell)
                            : openAssign(t, selDay, slotIdx),
                        style: {
                          padding: "3px",
                          border: "1px solid " + c.border,
                          background: isBooked
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Found ",
            freeSlotsForSubject(fSubj, selDay).length,
            "+ available slots",
          ),
        ),
        React.createElement(
          ...
          freeSlotsForSubject(fSubj, selDay).map((fs, i) =>
            React.createElement(
              "div",
              {
                key: i,
              ...
              React.createElement(
                "button",
                {
                  onClick: () =>
                    openAssign(
                      teachers.find((t) => t.code === fs.code),
                      selDay,
                      fs.slotIdx,
                    ),
                  style: {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          [
            ...
            [
              "Rating × 10",
              teachers[cmp1].rating * 10,
              teachers[cmp2].rating * 10,
              c.cyan,
            ],
          ].map(([metric, v1, v2, col]) =>
            React.createElement(
              "div",
              {
                key: metric,
              ...
              React.createElement(
                ...
                React.createElement("span", null, v2),
              ),
              React.createElement(
                "div",
                {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            [
              ["Teacher", cellModal.teacher.name],
              ["Code", cellModal.teacher.code],
              [
                "Day/Time",
                cellModal.day.toUpperCase() +
                  " " +
                  SUBJ_SLOTS[cellModal.slotIdx - 4] +
                  " PKT",
              ],
              ["USA Time", cellModal.cell.t || "—"],
              [
                "Pakistan Time",
                (() => {
              ...
              ["Parent/Lead", cellModal.cell.p],
              ["State", cellModal.cell.st],
              ["DOR", cellModal.cell.dor || "—"],
              ["Grade", cellModal.cell.gr],
            ].map(([l, v]) =>
              React.createElement(
                "div",
                {
          ...
          React.createElement(
            ...
            React.createElement(
              Btn,
              {
                ...
                icon: CheckCircle,
                onClick: () =>
                  markFree(cellModal.teacher, cellModal.day, cellModal.slotIdx),
              },
              "Mark as Free",
            ),
            React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              f.editing ? "Edit Subject Class" : "Assign Subject Class",
            ),
            React.createElement(
              "button",
              {
          ...
          React.createElement(
            ...
            "Teacher: ",
            teachers.find((t) => t.id === f.teacherId)?.name,
            " \xB7 ",
            f.day?.toUpperCase(),
            " ",
            SUBJ_SLOTS[f.slotIdx - 4],
            " PKT",
          ),
          React.createElement(
            "div",
