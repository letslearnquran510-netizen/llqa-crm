const HRMod = ({
  ...
  const handleCVUpload = async (e) => {
    ...
    try {
      ...
      console.warn(
        "Storage upload failed, likely Firebase Storage not enabled.",
        err,
      );
    }
    ...
    try {
      ...
      setForm({
        ...
        notes:
          ...
          file.name +
          "\nExtracted Email: " +
          (emailMatch ? emailMatch[1] : "None") +
          "\nExtracted Phone: " +
          (phoneMatch ? phoneMatch[1] : "None"),
        isParsing: false,
        parsingStatus: "",
        ...
        React.createElement(
          "button",
          {
            ...
            style: {
              ...
              color: tab === t.id ? c.accentText : c.textSec,
              border:
                tab === t.id
