const SettingsMod = ({
  ...
  const auditLog =
    liveAudit && liveAudit.length > 0
      ? [...liveAudit].sort((a, b) => new Date(b.time) - new Date(a.time))
      : LOGIN_AUDIT;
  const settings = appSettings || DEFAULT_SETTINGS;
  const setSettings = (v) =>
    setAppSettings(typeof v === "function" ? v(settings) : v);
  ...
  React.useEffect(() => {
    if (!initialSettingsRef.current && appSettings)
      initialSettingsRef.current = JSON.parse(JSON.stringify(appSettings));
  }, [appSettings]);
  ...
  return React.createElement(
    ...
    React.createElement(
                  ...
                  ? React.createElement(
                      ...
                      React.createElement("img", {
                        ...
                        style: {
                          ...
                          maxHeight: "100%",
                          width:
                            settings.logoFit === "stretch" ? "100%" : "auto",
                          height:
                            settings.logoFit === "stretch" ? "100%" : "auto",
                          objectFit:
                            settings.logoFit === "cover"
                              ? "cover"
                              : settings.logoFit === "stretch"
                                ? "fill"
                                : "contain",
                        },
                      }),
                ...
                Btn,
                {
                  ...
                  onClick: () => {
                    ...
                    input.onchange = (e) => {
                      ...
                      if (f.size > 500 * 1024) {
                        notice(
                          "Logo file too large. Please use an image under 500 KB.",
                        );
                        return;
                      }
              ...
              settings.logoDataUrl
                ? React.createElement(
                    Btn,
                    {
                      ...
                      onClick: () => {
                        if (
                          confirm("Remove custom logo and restore default?")
                        ) {
                          const { logoDataUrl, logoFileName, ...rest } =
                            settings;
                          setSettings(rest);
                        }
                      },
            ...
            React.createElement(
              Btn,
              {
                ...
                onClick: () => {
                  ...
                  if (!snapshot) {
                    alert(
                      "Nothing to reset (no changes detected since this page loaded).",
                    );
                    return;
                  }
                  ...
                  fields.forEach((k) => {
                    if (
                      ...
                      JSON.stringify(snapshot[k])
                    )
                      hasChanges = true;
                  });
                  if (!hasChanges) {
                    alert(
                      "No changes to undo — the profile is already in its last saved state.",
                    );
                    return;
                  }
                  if (
                    confirm(
                      "Discard all profile changes and restore to last saved state?\n\nThis will undo any edits you made since opening this page.",
                    )
                  ) {
                    const restored = {
                      ...settings,
            ...
            ? React.createElement(
                "div",
                {
                  style: {
                    ...
                    border:
                      "1px solid " +
                      (savedFlash === "save" ? c.success : c.warn) +
                      "66",
                    borderRadius: 8,
                    display: "flex",
                    alignItems: "center",
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    savedFlash === "save"
                      ...
                      : "\u21BB Profile reset to last saved state",
                  ),
                  React.createElement(
                    "div",
                    {
                    ...
                    savedFlash === "save"
                      ? "All changes have been committed. Auto-save also keeps changes safe as you type."
                      : "All your edits since opening this page have been undone.",
                  ),
                ),
              )
            : null,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  (teamLeads || []).length + " team leads configured",
                ),
                React.createElement(
                  "div",
                  {
                  ...
                  "Used in Add Teacher, Class Shifting, and filtering throughout the CRM",
                ),
              ),
              React.createElement(
                Btn,
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement("span", null, tl.group || "—"),
                      tl.email
                        ? React.createElement("span", null, "· " + tl.email)
                        : null,
                      tl.phone
                        ? React.createElement("span", null, "· " + tl.phone)
                        : null,
                    ),
                  ),
                  React.createElement(
                    ...
                    window._teachersForLeadCount
                      ? window._teachersForLeadCount(tl.name)
                      : "",
                  ),
                  React.createElement(
                    "button",
            ...
            React.createElement(
              ...
              'ℹ Tip: When you remove a team lead, any teachers currently assigned to them will be moved to the "ALL" group automatically. To prevent this, reassign teachers manually first via the Teachers module.',
            ),
          ),
          React.createElement(
            SettingCard,
            ...
            React.createElement(
              "button",
              {
                onClick: () => {
                  ...
                  if (confirm("Sign out " + others + " other device(s)?"))
                    notice(others + " device(s) signed out successfully.");
                },
                style: {
                  marginTop: 10,
                  background: c.dangerBg,
      ...
      section === "roles" &&
        React.createElement(
          React.Fragment,
          null,
          React.createElement(PortalAccessControl, {
            access: access,
            setAccess: setAccess,
          }),
          React.createElement(
            ...
            React.createElement(
              ...
              "Define what each role can access. Full = all actions, Edit = view+modify, View = read-only, Own = only own records, None = no access",
            ),
            React.createElement(
              "div",
              {
                ...
                React.createElement(
                  ...
                  rolePerms.map((p, i) =>
                    React.createElement(
                      ...
                      Object.entries(p.roles).map(([r, v]) =>
                        React.createElement(
                          "td",
                          {
                            key: r,
            ...
            rolesList.length > 0
              ? React.createElement(
                  ...
                  React.createElement(
                    ...
                    rolesList.length +
                      " Custom Role" +
                      (rolesList.length === 1 ? "" : "s"),
                  ),
                  rolesList.map((role) => {
                    const permList = Object.entries(role.permissions || {})
                      .filter(([k, v]) => v)
                      .map(([k, v]) => k);
                    return React.createElement(
                      "div",
      ...
      section === "notifications" &&
        React.createElement(
          ...
          React.createElement(
            ...
            [
              ["Welcome Email", "Sent to new students on enrollment", "Active"],
              ["Fee Reminder", "Sent 3 days before due date", "Active"],
              ["Fee Overdue", "Sent when payment is late", "Active"],
              ["Payment Receipt", "Sent after successful payment", "Active"],
              ["Class Cancellation", "Sent when class is cancelled", "Active"],
              [
                "Teacher Shift Notice",
                "Sent when student is reassigned",
                "Draft",
              ],
            ].map(([name, desc, st]) =>
              React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            [
              [
                "PayPal",
                "Most popular for US/CA/UK parents",
                "Connected",
                c.success,
                "pp@letslearnquran.net",
              ],
              ["Stripe", "Credit card payments", "Not Connected", c.danger, ""],
              [
                "Zelle",
                "US bank-to-bank",
                "Connected",
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  st === "Connected" ? "Configure" : "Connect",
                ),
              ),
            ),
          ),
          React.createElement(
            ...
            [
              ["JazzCash", "Mobile wallet", "Connected", "03120731001"],
              ["EasyPaisa", "Mobile wallet", "Connected", "03333186002"],
              ["HBL Bank", "Bank transfer", "Connected", "Account 1234567890"],
              [
                "Meezan Bank",
                "Islamic banking",
                "Connected",
              ...
              ["UBL Bank", "Bank transfer", "Connected", "Account 6285005678"],
            ].map(([name, desc, st, info]) =>
              React.createElement(
                "div",
                {
                  key: name,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Auto-updated daily. Override manually if needed.",
            ),
            React.createElement(
              "div",
              {
              ...
              [
                ["USD to PKR", 280, c.accent],
                ["CAD to PKR", 205, c.cyan],
                ["GBP to PKR", 355, c.purple],
              ].map(([l, v, col]) =>
                React.createElement(
                  "div",
                  {
      ...
      section === "pricing" &&
        React.createElement(
          ...
          React.createElement(
            ...
            [
              ["Noorani Qaida / English Qaida", 30, "USD", "Per month"],
              ["Quran Reading (Nazra)", 45, "USD", "Per month"],
              ["Quran with Tajweed", 50, "USD", "Per month"],
              ["Hifz / Memorization", 70, "USD", "Per month"],
              ["Quran + Memo + Islamic Ed", 80, "USD", "Per month (Combo)"],
              ["Subject Classes (Math/Eng/Sci)", 50, "USD", "Per month"],
              ["Saudi Quran (Special)", 55, "USD", "Per month"],
            ].map(([name, price, cur, freq], i) =>
              React.createElement(
                "div",
                {
                  key: name,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(Toggle, {
                  value:
                    settings.familyDiscount2 !== undefined
                      ? settings.familyDiscount2
                      : true,
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(Toggle, {
                  value:
                    settings.familyDiscount3 !== undefined
                      ? settings.familyDiscount3
                      : true,
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.annualDiscount !== undefined
                    ? settings.annualDiscount
                    : true,
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.referralBonus !== undefined
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.scholarshipFund !== undefined
                    ? settings.scholarshipFund
                    : true,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("input", {
                type: "number",
                value:
                  settings.gracePeriod !== undefined ? settings.gracePeriod : 5,
                onChange: (e) =>
            ...
            React.createElement(
              ...
              React.createElement("input", {
                type: "number",
                value:
                  settings.lateFeeAmount !== undefined
                    ? settings.lateFeeAmount
                    : 5,
                onChange: (e) =>
                  update("lateFeeAmount", parseInt(e.target.value) || 0),
                style: {
                  width: 70,
                  padding: "6px 10px",
                  background: c.bgInput,
            ...
            React.createElement(
              ...
              React.createElement("input", {
                type: "number",
                value:
                  settings.autoSuspendMonths !== undefined
                    ? settings.autoSuspendMonths
                    : 2,
                onChange: (e) =>
                  update("autoSuspendMonths", parseInt(e.target.value) || 0),
                style: {
                  width: 70,
                  padding: "6px 10px",
                  background: c.bgInput,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.ramadanAdjust !== undefined
                    ? settings.ramadanAdjust
                    : true,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                "Every login captured with photo, GPS, network, device fingerprint \xB7 ",
                auditLog.length,
                " entries (live)",
              ),
              React.createElement(
                ...
                React.createElement(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      border:
                        "1px solid " +
                        (l.status === "success" ? c.border : c.danger + "44"),
                      borderRadius: 10,
                      padding: 12,
                      alignItems: "flex-start",
                    },
                    ...
                    React.createElement(
                      ...
                      l.autoAttendance &&
                        React.createElement(
                          ...
                          "\u2713 Auto-attendance marked Present",
                        ),
                      l.reason &&
                        React.createElement(
                          "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Manage registered devices \xB7 ",
              auditLog.filter((l) => l.trusted).length,
              " trusted \xB7 ",
              auditLog.filter((l) => l.trusted === false).length,
              " flagged for review",
            ),
            [].map(([n, d, fp, st]) =>
              React.createElement(
                  ...
                  React.createElement(
                    "button",
                    {
                      onClick: () => {
                        if (
                          confirm(
                            "Revoke trust for this device? The user will need to re-verify on next login.",
                          )
                        )
                          notice("Device trust revoked.");
                      },
                      style: {
                        background: c.dangerBg,
                        border: "1px solid " + c.danger + "44",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.autoSecurityAudit !== undefined
                    ? settings.autoSecurityAudit
                    : true,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              [
                ["2FA Enabled", "✓", c.success],
                ["Strong Passwords", "✓", c.success],
                ["SSL/HTTPS", "✓", c.success],
                ["Backup Active", "✓", c.success],
                ["IP Whitelist", "○", c.warn],
                ["WAF Protection", "○", c.warn],
              ].map(([l, v, col]) =>
                React.createElement(
                  "div",
                  {
          ...
          React.createElement(
              ...
              React.createElement(
                ...
                [
                  ...
                  [
                    "auto",
                    "Auto (System)",
                    "linear-gradient(135deg,#0c1322,#f8fafc)",
                  ],
                ].map(([k, l, bg]) =>
                  React.createElement(
                    "button",
                    {
                      ...
                      style: {
                        background:
                          settings.theme === k ? c.accentBg : c.bgDeep,
                        border:
                          "2px solid " +
                          (settings.theme === k ? c.accent : c.border),
                        borderRadius: 8,
                        cursor: "pointer",
                        padding: "8px 14px",
                ...
                React.createElement(
                  "label",
                  {
                    ...
                    style: {
                      ...
                      justifyContent: "center",
                      background:
                        "conic-gradient(from 180deg,#ef4444,#f59e0b,#10b981,#06b6d4,#3b82f6,#8b5cf6,#ec4899,#ef4444)",
                      overflow: "hidden",
                      flexShrink: 0,
                    },
                  },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                [
                  ["full", "Full Color", "All 6 tones · vibrant"],
                  ["compact", "Compact", "Accent + semantic only"],
                  ["minimal", "Minimal", "Neutral + semantic only"],
                ].map(([k, l, d]) =>
                  React.createElement(
                    "button",
                    {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("option", null, "DD/MM/YYYY"),
                React.createElement("option", null, "MM/DD/YYYY"),
                React.createElement("option", null, "YYYY-MM-DD"),
              ),
            ),
            React.createElement(
              SettingRow,
              ...
              React.createElement(
                ...
                React.createElement("option", null, "PKR"),
                React.createElement("option", null, "CAD"),
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("option", null, "Monday"),
                React.createElement("option", null, "Sunday"),
                React.createElement("option", null, "Saturday"),
              ),
            ),
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("option", null, "Medium (Default)"),
      ...
      section === "integrations" &&
        React.createElement(
          ...
          React.createElement(
            ...
            [
              [
                ...
                "zoomConnected",
                c.accent,
                "Auto-generate meeting links for each class",
              ],
              [
                "Google Calendar",
                "Sync timetable with calendars",
                "googleConnected",
                c.success,
                "Two-way sync with teacher calendars",
              ],
              [
                "WhatsApp Business",
              ...
              [
                ...
                "smtpConnected",
                c.warn,
                "Configured: admin@letslearnquran.net",
              ],
              [
                "Hiring Email Sync",
                "Make.com/Zapier Webhook for CV parsing",
                "hiringSync",
                c.accent,
                "Automatically extracts PDFs from emails",
              ],
              [
                "Google Analytics",
          ...
          React.createElement(
            ...
            [
              ["Zoom API Key", "SDK Credentials", "zoom_sdk_xxxxx"],
              ["WhatsApp Business", "Phone Number ID", "+92_xxxxxxxxxx"],
              ["Google Workspace", "Service Account", "svc@llqa-prod.iam"],
              ["Stripe Secret", "Payment API", "sk_live_xxxxx"],
              ["Twilio", "SMS Account SID", "AC_xxxxxxxxxx"],
            ].map(([name, label, key]) =>
              React.createElement(
                "div",
                {
                ...
                React.createElement(
                  "button",
                  {
                    ...
                    style: {
                      background: revealedKeys.integrationsApi
                        ? c.warnBg
                        : c.bgDeep,
                      border:
                        "1px solid " +
                        (revealedKeys.integrationsApi ? c.warn : c.border),
                      borderRadius: 5,
                      cursor: "pointer",
                      padding: "4px 10px",
                  ...
                  revealedKeys.integrationsApi ? "Hide" : "Reveal",
                ),
              ),
            ),
          ),
      ...
      section === "backup" &&
        React.createElement(
          ...
          React.createElement(
              ...
              React.createElement(
                "button",
                {
                  onClick: () => {
                    if (
                      !confirm(
                        "Restoring will overwrite your current settings. Continue?",
                      )
                    )
                      return;
                    const input = document.createElement("input");
                    ...
                    input.onchange = (e) => {
                      ...
                      reader.onload = (ev) => {
                        try {
                          ...
                          if (data.teamLeads && setTeamLeads)
            ...
            [
              ["2026-04-23 12:00", "127 MB", "Auto"],
              ["2026-04-22 12:00", "126 MB", "Auto"],
              ["2026-04-21 15:30", "126 MB", "Manual"],
              ["2026-04-21 12:00", "125 MB", "Auto"],
            ].map(([dt, sz, tp]) =>
              React.createElement(
                "div",
                {
                ...
                React.createElement(
                  "button",
                  {
                    onClick: () => {
                      if (
                        confirm(
                          "Restore from this backup? Current settings will be overwritten.",
                        )
                      )
                        notice(
                          "Restore initiated. Settings will be applied shortly.",
                        );
                    },
                    style: {
                      background: "none",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("option", null, "July (Pakistan)"),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Configured holidays when classes are cancelled and teachers don't incur fines",
            ),
            [
              ["Eid ul-Fitr", "2026-03-31", "Islamic"],
              ["Eid ul-Adha", "2026-06-07", "Islamic"],
              ["Pakistan Day", "2026-03-23", "National"],
              ["Independence Day", "2026-08-14", "National"],
              ["Ramadan Start", "2026-02-18", "Islamic"],
            ].map(([name, date, type]) =>
              React.createElement(
                "div",
                {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("input", {
                  type: "number",
                  value:
                    settings.classDuration !== undefined
                      ? settings.classDuration
                      : 30,
                  onChange: (e) =>
                    update("classDuration", parseInt(e.target.value) || 0),
                  style: {
                    width: 60,
                    padding: "6px 10px",
                    background: c.bgInput,
            ...
            React.createElement(
              ...
              React.createElement("input", {
                type: "number",
                value:
                  settings.maxStudentsPerTeacher !== undefined
                    ? settings.maxStudentsPerTeacher
                    : 16,
                onChange: (e) =>
                  update(
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.cameraOnPolicy !== undefined
                    ? settings.cameraOnPolicy
                    : false,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Smart workflows that trigger automatically based on conditions",
            ),
            [
              [
                "When fee is 5 days overdue",
                "Send reminder email + WhatsApp",
                "Active",
              ],
              [
                "When teacher marks absent",
                "Notify team lead + reassign students",
                "Active",
              ],
              [
                "When student attendance < 75%",
                "Email parent + flag in report",
                "Active",
              ],
              [
                "When new student enrolls",
                "Send welcome email + assign teacher",
                "Active",
              ],
              ["When class cancelled", "Notify all affected parents", "Paused"],
            ].map(([when, then, st]) =>
              React.createElement(
                "div",
                {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Toggle, {
                value:
                  settings.apiAccess !== undefined ? settings.apiAccess : true,
              ...
              React.createElement(
                ...
                React.createElement(
                  "button",
                  {
                    ...
                    style: {
                      background: revealedKeys.advancedApi
                        ? c.warnBg
                        : c.accentBg,
                      border:
                        "1px solid " +
                        (revealedKeys.advancedApi ? c.warn : c.accent) +
                        "44",
                      borderRadius: 5,
                      cursor: "pointer",
                      padding: "6px 12px",
                  ...
                  revealedKeys.advancedApi ? "Hide" : "Reveal",
                ),
                React.createElement(
                  "button",
                  {
                    onClick: () => {
                      if (
                        ...
                        notice(
                          "New API key generated. Update your integrations with the new key.",
                        );
                    },
                    style: {
                      background: c.dangerBg,
            ...
            [
              ["Student enrolled", "https://llqa.net/hooks/enroll", "Active"],
              ["Payment received", "https://llqa.net/hooks/payment", "Active"],
              [
                "Teacher attendance",
                "https://llqa.net/hooks/attendance",
                "Active",
              ],
            ].map(([e, url, st]) =>
              React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              [
                ["Database", "Healthy", "99.9%", c.success],
                ["API Latency", "Fast", "45ms avg", c.success],
                ["Storage", "Good", "64% used", c.warn],
                ["Uptime", "99.98%", "Last 30d", c.success],
              ].map(([l, st, val, col]) =>
                React.createElement(
                  "div",
                  {
            ...
            React.createElement(
              ...
              React.createElement(
                "button",
                {
                  onClick: () => {
                    const t = prompt(
                      "⚠️ This will clear all cached data (audit logs, sessions, temp files).\n\nType CLEAR to confirm:",
                    );
              ...
              Btn,
              {
                onClick: () => {
                  ...
                  if (form.role === "Team Lead") {
                    const tlId =
                      Math.max(0, ...(teamLeads || []).map((t) => t.id)) + 1;
                    setTeamLeads([
                      ...(teamLeads || []),
                      {
                        id: tlId,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "ℹ This team lead will appear in all dropdowns immediately — Add Teacher, Class Shifting, Smart Finder filters.",
          ),
          React.createElement(
            "div",
            {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "⚠ Renaming this team lead will NOT auto-update teachers already assigned. To rename safely, add the new name first, reassign teachers, then remove the old.",
          ),
          React.createElement(
            "div",
            {
                      ...
                      if (setShifts && shifts) {
                        setShifts(
                          shifts.map((s) => ({
                            ...s,
                            fromLead:
                              s.fromLead === oldName ? newName : s.fromLead,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            " from the team leads list. This will:",
          ),
          React.createElement(
            "ul",
            {
            ...
            React.createElement(
              "li",
              null,
              "Remove them from all Team Lead dropdowns immediately",
            ),
            React.createElement(
              "li",
              null,
              "Existing teachers assigned to them will keep their assignment label, but you should reassign them manually",
            ),
          ),
          React.createElement(
            "div",
              ...
              Btn,
              {
                ...
                onClick: () => {
                  ...
                  (() => {
                    ...
                    setTeamLeads(
                      (teamLeads || []).filter((t) => t.id !== tl.id),
                    );
                    if (removedName) {
                      if (setTeachers && teachers) {
                        setTeachers(
                          teachers.map((t) =>
                            t.teamLead === removedName
                              ? {
                                  ...t,
                                  teamLead: "",
                                }
                      ...
                      if (setShifts && shifts) {
                        setShifts(
                          shifts.map((s) => ({
                            ...s,
                            fromLead:
                              s.fromLead === removedName ? "" : s.fromLead,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              Btn,
              {
                ...
                onClick: () => {
                  ...
                  if (editingId) {
                    ...
                    const newId =
                      Math.max(0, ...rolesList.map((r) => r.id || 0)) + 1;
              ...
              form._editingId ? "Save Changes" : "Create Role",
            ),
          ),
        ),
      ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Edit Email Template - " + (form.templateName || ""),
            ),
            React.createElement(
              "button",
              {
          ...
          React.createElement(
            ...
            "Available variables: {{name}}, {{email}}, {{course}}, {{teacher}}, {{date}}, {{amount}}",
          ),
          React.createElement(
            "div",
            {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              "Edit " + (form.methodName || "Payment Method"),
            ),
            React.createElement(
              "button",
              {
    ...
    modal &&
      modal.type === "configureIntegration" &&
      React.createElement(
        "div",
        {
          style: {
          ...
          React.createElement(
            ...
            React.createElement(
              Btn,
              {
                ...
                onClick: () => {
                  notice(
                    ((modal.data && modal.data.name) || "Integration") +
                      " configured.",
                  );
                  setModal(null);
                },
    ...
    modal &&
      (modal.type === "editAutomation" || modal.type === "newAutomation") &&
      React.createElement(
        "div",
        {
          style: {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "\u26A1 Rule will run automatically when the trigger condition is met.",
          ),
          React.createElement(
            "div",
            {
    ...
    modal &&
      (modal.type === "configureGateway" || modal.type === "connectGateway") &&
      React.createElement(
        "div",
        {
          style: {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              (modal.type === "connectGateway" ? "Connect " : "Configure ") +
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              modal.type === "connectGateway" ? "Connect" : "Save",
            ),
          ),
        ),
      ),
    modal &&
      modal.type === "adjustLogo" &&
      React.createElement(
        "div",
        {
          style: {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            form.tempLogoFile || "New logo",
            " — choose how it should display",
          ),
          React.createElement(
            "div",
            {
              ...
              React.createElement(
                "button",
                {
                  ...
                  style: {
                    ...
                    border:
                      "2px solid " +
                      (form.logoFit === fit ? c.accent : c.border),
                    borderRadius: 8,
                    cursor: "pointer",
                ...
                style: {
                  ...
                  background:
                    col === "transparent"
                      ...
                      : col,
                  border:
                    "2px solid " + (form.logoBg === col ? c.accent : c.border),
                },
              }),
            ),
            React.createElement(
              ...
              React.createElement("input", {
                type: "color",
                value:
                  form.logoBg && form.logoBg.startsWith("#")
                    ? form.logoBg
                    : "#4a7aff",
                onChange: (e) =>
                  setForm({
