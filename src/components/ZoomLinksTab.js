const ZoomLinksTab = ({ teachers, onQuickEdit }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      [
        ["Total Teachers", list.length, c.accent, Users],
        ["With Zoom Link", withLink.length, c.success, Video],
        [
          "Missing Link",
          missing.length,
          missing.length > 0 ? c.warn : c.textMuted,
          AlertTriangle,
        ],
      ].map((a) =>
          ...
          React.createElement(
            ...
            has &&
              React.createElement(
                "button",
                {
                  onClick: () => copyLink(t),
                  style: actBtn(
                    isCopied ? c.successBg : c.bgDeep,
                    isCopied ? c.success + "55" : c.border,
                    isCopied ? c.success : c.textSec,
                  ),
                },
            ...
            React.createElement(
              "button",
              {
                ...
                style: Object.assign(
                  actBtn(c.bgDeep, c.border, c.textSec),
                  has
                    ? {}
                    : {
                        marginLeft: "auto",
