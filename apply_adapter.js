...
const regex = /const SubjectsMod = \(\{ teachers: appTeachers, setTeachers: setAppTeachers \}\) => \{[\s\S]*?const setTeachers = \(newTeachers\) => \{[\s\S]*?\}\);\s*\};/;
...
if (regex.test(code)) {
  ...
  console.log("Replaced adapter successfully!");
} else {
