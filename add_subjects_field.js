...
const regex = /label: "Location \*",\s*value: form\.location \|\| "",\s*onChange: \(v\) =>\s*setForm\(\{\s*\.\.\.form,\s*location: v,\s*\}\),\s*options: \["WFH", "IBA"\],\s*\}\),/;
...
const replacementStr = `label: "Location *",
            ...
            React.createElement(Inp, {
              label: "Teaches Subjects? (e.g. Math, Science)",
...
if (regex.test(code)) {
  ...
  console.log("Added Teaches Subjects to TeachMod.js form!");
} else {
