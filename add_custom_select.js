...
const CustomSelect = ({ options, value, onChange, style, placeholder = "Select..." }) => {
...
if (!code.includes('const CustomSelect = ({')) {
  code = code + '\n' + customSelectCode + '\n';
  fs.writeFileSync('src/core/common.js', code);
  console.log('CustomSelect added to common.js');
} else {
  console.log('CustomSelect already exists in common.js');
}
